...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = $tasks->map(function ($task) {
            return [
                ...
                'video' => $task->video,
                'image' => $task->image ? Storage::disk('public')->url($task->image) : null,
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            // Store the file in public disk with user email folder structure
        ...
        $data = $task->toArray();
        $data['image'] = $task->image ? Storage::disk('public')->url($task->image) : null;
    ...
    public function show(string $id)
    {
        ...
        $taskData['image'] = $task->image ? Storage::disk('public')->url($task->image) : null;
...
//     //     $image      = $request->file('image');
//     //     $imageName  = time().'_'.$image->getClientOriginalName();
//     //     // simpan ke storage/app/public/{email}/tasks/{imageName}
//     //     $path = $image->storeAs(
//     //         $user->email.'/tasks',
//     //         $imageName,
//     //         'public'
...
//     //     // 3) Simpan path relatif (tanpa 'public/') ke DB
//     //     $task->image = $path;
//     // }
